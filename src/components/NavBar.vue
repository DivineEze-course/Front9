...
<template>
    <div class=" hidden lg:flex p-6 bg-black gap-20 justify-center items-center z-10">
        <RouterLink to="/">
        ...
        <div class=" hidden lg:flex font-bold text-[rgb(46,189,182)] gap-10 text-lg">
        
        <RouterLink to="/login">    <p class=" p-1 ps-2 pe-2 bg-white/20 backdrop-blur-lg  border border 
        border-white/20 shadow-xl overflow-hidden transition hover:scale-102 
        hover:bg-white/15 rounded-md  cursor-pointer"
        >Login</p>
        </RouterLink>
        <RouterLink to="/signup">
        <p class=" p-1 ps-2 pe-2 bg-white/20 backdrop-blur-lg  border border 
        border-white/20 shadow-xl overflow-hidden transition hover:scale-102 
        hover:bg-white/15 rounded-md  cursor-pointer"
        >Sign Up</p>
        </RouterLink>
